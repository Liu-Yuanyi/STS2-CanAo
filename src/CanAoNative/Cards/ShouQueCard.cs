...
{
    public override string PortraitPath => "res://images/card_portraits/canao/shou_que.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/shou_que.png";
