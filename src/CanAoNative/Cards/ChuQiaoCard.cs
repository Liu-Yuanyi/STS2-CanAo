...
{
    public override string PortraitPath => "res://images/card_portraits/canao/chu_qiao.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/chu_qiao.png";
