...
{
    public override string PortraitPath => "res://images/card_portraits/canao/tian_feng_jun_zhen.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/tian_feng_jun_zhen.png";
