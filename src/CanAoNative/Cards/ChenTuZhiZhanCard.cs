...
{
    public override string PortraitPath => "res://images/card_portraits/canao/chen_tu_zhi_zhan.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/chen_tu_zhi_zhan.png";
