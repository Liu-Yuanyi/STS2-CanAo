...
{
    public override string PortraitPath => "res://images/card_portraits/canao/shi_wei.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/shi_wei.png";
