...
{
    public override string PortraitPath => "res://images/card_portraits/canao/jin_yu_hui_xuan.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/jin_yu_hui_xuan.png";
