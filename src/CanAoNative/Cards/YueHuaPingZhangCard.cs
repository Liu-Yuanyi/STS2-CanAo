...
{
    public override string PortraitPath => "res://images/card_portraits/canao/yue_hua_ping_zhang.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/yue_hua_ping_zhang.png";
