...
{
    public override string PortraitPath => "res://images/card_portraits/canao/xing_yue_fa_mo.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/xing_yue_fa_mo.png";
