...
{
    public override string PortraitPath => "res://images/card_portraits/canao/xing_yue_wang_guan.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/xing_yue_wang_guan.png";
