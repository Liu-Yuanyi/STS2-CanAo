...
{
    public override string PortraitPath => "res://images/card_portraits/canao/huo_ren.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/huo_ren.png";
