...
{
    public override string PortraitPath => "res://images/card_portraits/canao/yu_qian_cai_jue.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/yu_qian_cai_jue.png";
