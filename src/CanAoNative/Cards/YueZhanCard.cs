...
{
    public override string PortraitPath => "res://images/card_portraits/canao/yue_zhan.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/yue_zhan.png";
