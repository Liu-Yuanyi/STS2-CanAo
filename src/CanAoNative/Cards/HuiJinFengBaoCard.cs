...
{
    public override string PortraitPath => "res://images/card_portraits/canao/hui_jin_feng_bao.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/hui_jin_feng_bao.png";
