...
{
    public override string PortraitPath => "res://images/card_portraits/canao/zhui_xing_wei_yue.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/zhui_xing_wei_yue.png";
