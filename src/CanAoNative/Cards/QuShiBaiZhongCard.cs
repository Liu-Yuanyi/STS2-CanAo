...
{
    public override string PortraitPath => "res://images/card_portraits/canao/qu_shi_bai_zhong.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/qu_shi_bai_zhong.png";
