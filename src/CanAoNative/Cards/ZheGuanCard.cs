...
/// <summary>
/// 折冠：虚无。失去 1 点凤威，获得 2（3）星和 2（3）月。
/// </summary>
public sealed class ZheGuanCard : CardModel
{
    public override string PortraitPath => "res://images/card_portraits/canao/zhe_guan.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/zhe_guan.png";
