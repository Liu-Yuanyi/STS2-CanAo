...
{
    public override string PortraitPath => "res://images/card_portraits/canao/feng_huo.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/feng_huo.png";
