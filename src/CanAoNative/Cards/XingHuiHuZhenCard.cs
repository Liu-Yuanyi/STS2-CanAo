...
{
    public override string PortraitPath => "res://images/card_portraits/canao/xing_hui_hu_zhen.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/xing_hui_hu_zhen.png";
