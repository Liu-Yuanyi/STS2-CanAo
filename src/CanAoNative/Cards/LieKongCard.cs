...
{
    public override string PortraitPath => "res://images/card_portraits/canao/lie_kong.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/lie_kong.png";
