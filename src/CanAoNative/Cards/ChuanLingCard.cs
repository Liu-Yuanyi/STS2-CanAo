...
{
    public override string PortraitPath => "res://images/card_portraits/canao/chuan_ling.png";
    protected override string PortraitPngPath => "res://images/card_portraits/canao/chuan_ling.png";
